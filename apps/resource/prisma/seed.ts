...
const BLOGS = [
  {
    ...
    content: 'Học tiếng Anh không khó nếu bạn có phương pháp đúng đắn. Hãy dành 30 phút mỗi ngày để luyện nghe, nói, đọc, viết. Quan trọng nhất là sự kiên trì và thực hành thường xuyên. Bắt đầu với những chủ đề đơn giản và tăng dần độ khó.',
    tags: ['tieng-anh', 'hoc-tap', 'phuong-phap'],
  },
  {
    title: '5 lỗi thường gặp khi phát âm tiếng Anh',
    content: 'Người Việt thường gặp khó khăn với các âm /θ/, /ð/, /ʃ/, /ʒ/. Cách khắc phục tốt nhất là luyện tập trước gương và ghi âm lại giọng đọc của mình để so sánh với người bản xứ.',
    tags: ['phat-am', 'tieng-anh', 'luyen-tap'],
  },
  {
    title: 'Từ vựng tiếng Anh chủ đề công sở',
    content: 'Dưới đây là những từ vựng thông dụng trong môi trường công sở: meeting (cuộc họp), deadline (hạn chót), collaborate (hợp tác), presentation (bài thuyết trình), và many more!',
    tags: ['tu-vung', 'cong-so', 'tieng-anh'],
  },
  {
    title: 'Làm thế nào để viết email chuyên nghiệp bằng tiếng Anh',
    content: 'Một email chuyên nghiệp cần có tiêu đề rõ ràng, lời chào phù hợp, nội dung ngắn gọn và kết thúc lịch sự. Đừng quên kiểm tra chính tả trước khi gửi!',
    tags: ['email', 'viet-lach', 'tieng-anh'],
  },
  {
    title: 'Bí quyết luyện nghe tiếng Anh qua podcast',
    content: 'Podcast là công cụ tuyệt vời để luyện nghe tiếng Anh. Hãy chọn những chủ đề bạn yêu thích, nghe có phụ đề trước, sau đó nghe lại không phụ đề và ghi chép lại những gì bạn hiểu được.',
